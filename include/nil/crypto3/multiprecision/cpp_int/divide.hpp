            ...
            namespace backends {
                ...
                BOOST_MP_CXX14_CONSTEXPR void divide_unsigned_helper_core( CppInt1*       result,
                    ...
                    if (r_order == 0) {
                        ...
                        double_limb_type b =
                            y_order ? (static_cast<double_limb_type>(py[1]) << CppInt1::limb_bits) | py[0] : py[0];
                        if (result) {
                            *result = a / b;
                        }
                        r = a % b;
                    ...
                    do {
                        ...
                        if ((prem[r_order] <= py[y_order]) && (r_order > 0)) {
                            double_limb_type a = (static_cast<double_limb_type>(prem[r_order]) << CppInt1::limb_bits) |
                                                 prem[r_order - 1];
                            ...
                            double_limb_type a = (static_cast<double_limb_type>(prem[r_order]) << CppInt1::limb_bits) |
                                                 prem[r_order - 1];
                            double_limb_type b =
                                (y_order > 0) ? (static_cast<double_limb_type>(py[y_order]) << CppInt1::limb_bits) |
                                                    py[y_order - 1] :
                                                (static_cast<double_limb_type>(py[y_order]) << CppInt1::limb_bits);
                            BOOST_ASSERT(b);
                            double_limb_type v = a / b;
                            guess = static_cast<limb_type>(v);
                        }
                    ...
                    BOOST_ASSERT(r.compare_unsigned(y) <
                ...
                BOOST_MP_CXX14_CONSTEXPR void
                    ...
                    do {
                        ...
                        if ((pr[r_order] < y) && r_order) {
                            double_limb_type a =
                                (static_cast<double_limb_type>(pr[r_order]) << CppInt1::limb_bits) | pr[r_order - 1];
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<
                    ...
                    type
                    eval_divide(cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& result,
                ...
                BOOST_MP_FORCEINLINE BOOST_MP_CXX14_CONSTEXPR typename std::enable_if<
                    ...
                    !is_trivial_cpp_int<cpp_int_backend<MinBits3, MaxBits3, SignType3, Checked3, Allocator3>>::value>::
                    type
                    eval_modulus(cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>& result,
                                 const cpp_int_backend<MinBits2, MaxBits2, SignType2, Checked2, Allocator2>& a,
                                 const cpp_int_backend<MinBits3, MaxBits3, SignType3, Checked3, Allocator3>& b) {
                    bool s = a.sign();
                    if (b.size() == 1)
                        ...
                        divide_unsigned_helper(
                            static_cast<cpp_int_backend<MinBits1, MaxBits1, SignType1, Checked1, Allocator1>*>(0),
                            a,
                            b,
                            result);
                    result.sign(s);
